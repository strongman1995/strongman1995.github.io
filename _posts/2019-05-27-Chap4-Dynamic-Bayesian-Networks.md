...
![](/Users/chenlu/strongman1995.github.io/assets/images/2019-05-27-chap4/1.png)
...
![image-20190527140619382](/Users/chenlu/strongman1995.github.io/assets/images/2019-05-27-chap4/2.png)



![image-20190527140716298](/Users/chenlu/strongman1995.github.io/assets/images/2019-05-27-chap4/3.png)
...
![](/Users/chenlu/strongman1995.github.io/assets/images/2019-05-27-chap4/5.png)

这里的$$\pi_i=P(Y_i), e_{i, x_i}=P(X_i|Y_i), t_{j, i}=P(Y_{i}|Y_{j})$$, 所以$$\alpha_{t+1}(i)$$不断迭代的过程其实就是在P(XY)的连乘式子上不断添加项，并且做消元，下面另一个方向也是同理。

![](/Users/chenlu/strongman1995.github.io/assets/images/2019-05-27-chap4/6.png)
...
![](/Users/chenlu/strongman1995.github.io/assets/images/2019-05-27-chap4/7.png)
...
![](/Users/chenlu/strongman1995.github.io/assets/images/2019-05-27-chap4/8.png)
...
![](/Users/chenlu/strongman1995.github.io/assets/images/2019-05-27-chap4/11.png)

使用 Gibbs sampling 来得到隐变量的概率，其实最后只需要保留和 $$y_t$$相关的项，即$$y_t$$的 Markov blanket，然后他们的条件概率相乘就行。然后用采样出来的样本，重新估计新的参数 T 和 E

![](/Users/chenlu/strongman1995.github.io/assets/images/2019-05-27-chap4/12.png)
